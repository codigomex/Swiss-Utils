...
def _parr(
    ...
    """
    Solo formatea y devuelve el string. No imprime nada.
    """
    if not msje.strip():
        return ""
...
def pparr(*args, **kwargs) -> None:
    """Imprime el resultado de _parr."""
    print(_parr(*args, **kwargs))


def waiti(*args, **kwargs) -> str:
    """Usa el resultado de _parr como prompt del input."""
    return input(_parr(*args, **kwargs))
