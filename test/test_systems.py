...
from py_utils.system import tmp_fname


@patch("py_utils.system.TMP_DIR", Path("/fake/dir"))
@patch("py_utils.system.Path.exists", side_effect=[True, False])
def test_tmp_fname_collision(mock_exists) -> None:
    ...
    with patch("py_utils.system.sleep", return_value=None):
        fname = tmp_fname("txt")
